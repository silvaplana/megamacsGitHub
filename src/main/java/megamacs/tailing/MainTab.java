...
public class MainTab extends ButtonTabComponent {
	...
	public MainTab(JTabbedPane inPane, File inFile, SettingHandler settingHandler) throws FileNotFoundException {
		super(inPane, inFile);
